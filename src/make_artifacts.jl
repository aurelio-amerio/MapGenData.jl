...
function fetch_fermilat_data(fits_artifact::FITSArtifact)
    ...
    #4FGL-DR4 catalog
    gll_psc_url_35 = "https://fermi.gsfc.nasa.gov/ssc/data/access/lat/14yr_catalog/gll_psc_v35.fit"
    gll_psc_url_33 = "https://fermi.gsfc.nasa.gov/ssc/data/access/lat/14yr_catalog/gll_psc_v33.fit"
    ...
    # if ! isfile(joinpath(fits_cache, "gll_psc_v33.fit"))
    #     Downloads.download(gll_psc_url_33, joinpath(fits_cache,"gll_psc_v33.fit"))
    # end

    if ! isfile(joinpath(fits_cache, "gll_psc_v35.fit"))
        Downloads.download(gll_psc_url_35, joinpath(fits_cache,"gll_psc_v35.fit"))
    end
...
function make_fits_artifact(fits_artifact::FITSArtifact)
    ...
    # cp(joinpath(fits_cache, "gll_psc_v33.fit"), joinpath(tmp_dir, "gll_psc_v33.fit"), force=true)
    cp(joinpath(fits_cache, "gll_psc_v35.fit"), joinpath(tmp_dir, "gll_psc_v35.fit"), force=true)
