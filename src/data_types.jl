...
function JLD2Artifact{S}(outdir::String, nside::Int, name::String, Emin_array::AbstractVector{Float64}, Emax_array::AbstractVector{Float64}) where {S}
    ...
    return JLD2Artifact{S}(outdir, nside, name, Emin_sv, Emax_sv)
end

function JLD2Artifact(outdir::String, nside::Int, name::String, Emin_array::AbstractVector, Emax_array::AbstractVector)
